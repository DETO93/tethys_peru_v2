...
#http://localhost:8080/apps/national-water-level-forecast-peru/get-data/?codigo=230603&comid=9043597&nombre=LAGUNAS&width=1106
...
def get_data(request):
    ...
    station_code = 230603
    station_comid = 9043597
    station_name = "LAGUNAS"
    ...
    # Data series
    observed_data = get_format_data("select * from wl_{0} order by datetime;".format(station_code), conn)
