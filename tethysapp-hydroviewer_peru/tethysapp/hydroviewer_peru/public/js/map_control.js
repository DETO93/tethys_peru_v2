...
const loc_url = `${server}/static/hydroviewer_peru/geojson/loc/`
...
const subloc_url = `${server}/static/hydroviewer_peru/geojson/subloc/`
...
const basin_url = `${server}/static/hydroviewer_peru/geojson/basin/`
